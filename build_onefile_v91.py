...
webui = []
for fname in ('index.html','styles.css','echarts.min.js','app.js','chart_interactive.js','chart_realtime.js','pa_llm_ui.js','rt_monitor.js','sentiment_panel.js'):
    webui += ['--add-data', j('webui', fname) + os.pathsep + 'webui']
PyInstaller.__main__.run([
    '--noconfirm','--onefile','--windowed','--name','dsr_sr',
    '--distpath', j('dist_v91'), '--workpath', j('build_v91'), '--specpath', HERE,
    '--paths', HERE,
    ...
    '--hidden-import','aiquant.rt_agent_module','--hidden-import','aiquant.pa_llm','--hidden-import','aiquant.market','--hidden-import','aiquant.market_sentiment','--hidden-import','aiquant.signal_engine',
